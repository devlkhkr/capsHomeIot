var ReinventedColorWheel = (function () {
  ...
  function h(e) {
    var t = e[0] / 60,
      ...
      i = h * n,
      r = h - i,
      s = (255 * (i * (1 - Math.abs((t % 2) - 1)) + r) + 0.5) | 0,
      a = (255 * (i + r) + 0.5) | 0,
      o = (255 * r + 0.5) | 0,
      l = 0 | t;
    return 1 === l
  ...
  function i(e) {
    var t,
      n = Math.round(((t = e), 0, 255, Math.min(Math.max(t, 0), 255))).toString(
        16
      );
  ...
  var v = "undefined" != typeof globalThis ? globalThis : self,
    d =
      "PointerEvent" in v
        ? function (e, t, n) {
    ...
    f = v.DOMMatrix || v.WebKitCSSMatrix || v.MSCSSMatrix,
    m = function (e, t) {
    ...
    function i(e) {
      ...
      var n = function (e, n) {
        ...
        h = function (e) {
          ...
          t._center = n(h.left + h.width / 2, h.top + h.height / 2);
        },
        r = function (e) {
          var h = n(e.clientX, e.clientY),
            ...
            r = h.y - t._center.y,
            s = Math.atan2(r, i);
          t.hsv = [(180 * s) / Math.PI + 90, t.hsv[1], t.hsv[2]];
        },
        s = function (e) {
          var h = n(e.clientX, e.clientY),
      ...
      d(
        ...
        d(this.svSpaceElement, l, s),
        d(this.svHandleElement, l, s),
        this.redraw();
    }
    return (
      ...
      Object.defineProperty(i.prototype, "hsl", {
        ...
        set: function (e) {
          m(this._hsl, e) || this._setHSV(i.hsl2hsv(e));
        },
        enumerable: !1,
        configurable: !0,
      }),
      Object.defineProperty(i.prototype, "rgb", {
        ...
        set: function (e) {
          m(this._rgb, e) || this._setHSV(i.rgb2hsv(e));
        },
        enumerable: !1,
        configurable: !0,
      }),
      ...
      (i.prototype.redraw = function () {
        (this.hueWheelElement.width = this.hueWheelElement.height =
          this.wheelDiameter),
          (this.svSpaceElement.width = this.svSpaceElement.height =
            (this.wheelDiameter - 2 * this.wheelThickness) * Math.SQRT1_2);
        var e = this.hueHandleElement.style,
          t = this.svHandleElement.style;
        (e.width = e.height = t.width = t.height = this.handleDiameter + "px"),
          (e.marginLeft =
            e.marginTop =
            t.marginLeft =
            t.marginTop =
      ...
      (i.prototype._setHSV = function (e) {
        var t = this._hsv,
          ...
          r = t[1] - n[1] || t[2] - n[2];
        h &&
          ((this._hsl = [n[0], this._hsl[1], this._hsl[2]]),
          this._redrawHueHandle(),
          this._updateSvBackground()),
          r &&
            ((this._hsl = o(i.hsv2hsl(n))),
            this._redrawSvHandle(),
            this.wheelReflectsSaturation &&
      ...
      (i.prototype._updateSvBackground = function () {
        this.svSpaceElement.style.backgroundColor =
          "hsl(" + this._hsv[0] + ",100%,50%)";
      }),
      (i.prototype._redrawHueHandle = function () {
        ...
        (h.left = t * Math.cos(n) + e + "px"),
          (h.top = t * Math.sin(n) + e + "px");
      }),
      (i.prototype._redrawSvHandle = function () {
        var e = this.svSpaceElement.width,
          ...
          h = this._hsv;
        (t.left = n + (e * h[1]) / 100 + "px"),
          (t.top = n + e * (1 - h[2] / 100) + "px");
      }),
      (i.default = i),
      (i.defaultOptions = p),
      (i.hsv2hsl = t),
